...
public class BankForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Current balance is:");
    ...
    long acc = Long.parseLong(jTextField6.getText());
    String nm = jTextField7.getText();
    double with=Double.parseDouble(jTextField4.getText());
    double balance=10000;
    double rem=bank1.withdrawal(with);
    jTextField8.setText(Double.toString(rem));
    Date date=new Date();
    SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
    String strDate = formatter.format(date);
    jLabel9.setText(strDate);
    ...
    double balance=10000;
    double rem=bank1.withdrawal(with);
    jLabel10.setText(Double.toString(rem));
